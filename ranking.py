...
class rank_list:
    ...
    def rank(self):
        ...
        self.rank_label1 = Label(self.root, font=('NanumGothic', 20,'bold'),anchor='w',height=5, width=16,text='1위 양유빈님',fg="black", bg="white")
        self.rank_label2 = Label(self.root, font=('NanumGothic', 20,'bold'), anchor='w',height=5, width=16,text='2위 이지석님',fg="black", bg="white")
        self.rank_label3 = Label(self.root, font=('NanumGothic', 20,'bold'), anchor='w',height=5, width=16,text='3위 김병찬님',fg="black", bg="white")
        ...
        self.canvas.create_window(600, 1030, window=self.line_image)
